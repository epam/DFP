...
namespace EPAM.Deltix.DFP.Test
{
	...
	class Decimal64Test
	{
		...
		public void TestParseReImpl()
		{
			...
			uint fpsf = 0;
			var value = Decimal64.FromUnderlying(DotNetReImpl.bid64_from_string("0.", DotNetReImpl.BID_ROUNDING_TO_NEAREST, ref fpsf));
		...
		static void Main()
		{
			new Decimal64Test().TestParseReImpl();
		}
	}
}
