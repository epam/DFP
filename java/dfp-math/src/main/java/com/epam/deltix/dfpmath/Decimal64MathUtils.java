...
public class Decimal64MathUtils {
    ...
    public static long exp(@Decimal final long x) {
        return NativeMathImpl.bid64Exp(x);
    }
    ...
    public static long exp2(@Decimal final long x) {
        return NativeMathImpl.bid64Exp2(x);
    }
    ...
    public static long exp10(@Decimal final long x) {
        return NativeMathImpl.bid64Exp10(x);
    }
    ...
    public static long expm1(@Decimal final long x) {
        return NativeMathImpl.bid64Expm1(x);
    }
    ...
    public static long log(@Decimal final long x) {
        return NativeMathImpl.bid64Log(x);
    }
    ...
    public static long log2(@Decimal final long x) {
        return NativeMathImpl.bid64Log2(x);
    }
    ...
    public static long log10(@Decimal final long x) {
        return NativeMathImpl.bid64Log10(x);
    }
    ...
    public static long log1p(@Decimal final long x) {
        return NativeMathImpl.bid64Log1p(x);
    }
    ...
    public static long pow(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64Pow(x, y);
    }
    ...
    public static long fmod(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64Fmod(x, y);
    }
    ...
    public static long hypot(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64Hypot(x, y);
    }
    ...
    public static long sin(@Decimal final long x) {
        return NativeMathImpl.bid64Sin(x);
    }
    ...
    public static long cos(@Decimal final long x) {
        return NativeMathImpl.bid64Cos(x);
    }
    ...
    public static long tan(@Decimal final long x) {
        return NativeMathImpl.bid64Tan(x);
    }
    ...
    public static long asin(@Decimal final long x) {
        return NativeMathImpl.bid64Asin(x);
    }
    ...
    public static long acos(@Decimal final long x) {
        return NativeMathImpl.bid64Acos(x);
    }
    ...
    public static long atan(@Decimal final long x) {
        return NativeMathImpl.bid64Atan(x);
    }
    ...
    public static long atan2(@Decimal final long y, @Decimal final long x) {
        return NativeMathImpl.bid64Atan2(y, x);
    }
    ...
    public static long sinh(@Decimal final long x) {
        return NativeMathImpl.bid64Sinh(x);
    }
    ...
    public static long cosh(@Decimal final long x) {
        return NativeMathImpl.bid64Cosh(x);
    }
    ...
    public static long tanh(@Decimal final long x) {
        return NativeMathImpl.bid64Tanh(x);
    }
    ...
    public static long asinh(@Decimal final long x) {
        return NativeMathImpl.bid64Asinh(x);
    }
    ...
    public static long acosh(@Decimal final long x) {
        return NativeMathImpl.bid64Acosh(x);
    }
    ...
    public static long atanh(@Decimal final long x) {
        return NativeMathImpl.bid64Atanh(x);
    }
    ...
    public static long erf(@Decimal final long x) {
        return NativeMathImpl.bid64Erf(x);
    }
    ...
    public static long erfc(@Decimal final long x) {
        return NativeMathImpl.bid64Erfc(x);
    }
    ...
    public static long tgamma(@Decimal final long x) {
        return NativeMathImpl.bid64Tgamma(x);
    }
    ...
    public static long lgamma(@Decimal final long x) {
        return NativeMathImpl.bid64Lgamma(x);
    }

    //@Decimal public static long add(@Decimal final long x, @Decimal final long y) { return NativeMathImpl.bid64Add(x, y); }
    ...
    public static long sub(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64Sub(x, y);
    }
    ...
    public static long mul(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64Mul(x, y);
    }
    ...
    public static long div(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64Div(x, y);
    }
    ...
    public static long fma(@Decimal final long x, @Decimal final long y, @Decimal final long z) {
        return NativeMathImpl.bid64Fma(x, y, z);
    }
    ...
    public static long sqrt(@Decimal final long x) {
        return NativeMathImpl.bid64Sqrt(x);
    }
    ...
    public static long cbrt(@Decimal final long x) {
        return NativeMathImpl.bid64Cbrt(x);
    }

    //public static boolean isEqual(@Decimal final long x, @Decimal final long y) { return NativeMathImpl.bid64QuietEqual(x, y) ; }

    //public static boolean isGreater(@Decimal final long x, @Decimal final long y) { return NativeMathImpl.bid64QuietGreater(x, y) ; }

    //public static boolean isGreaterEqual(@Decimal final long x, @Decimal final long y) { return NativeMathImpl.bid64QuietGreaterEqual(x, y); }
    ...
    public static boolean isGreaterUnordered(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64QuietGreaterUnordered(x, y);
    }

    //public static boolean isLess(@Decimal final long x, @Decimal final long y) { return NativeMathImpl.bid64QuietLess(x, y) ; }

    //public static boolean isLessEqual(@Decimal final long x, @Decimal final long y) { return NativeMathImpl.bid64QuietLessEqual(x, y); }
    ...
    public static boolean isLessUnordered(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64QuietLessUnordered(x, y);
    }

    //public static boolean isNotEqual(@Decimal final long x, @Decimal final long y) { return NativeMathImpl.bid64QuietNotEqual(x, y) ; }
    ...
    public static boolean isNotGreater(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64QuietNotGreater(x, y);
    }
    ...
    public static boolean isNotLess(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64QuietNotLess(x, y);
    }
    ...
    public static boolean isOrdered(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64QuietOrdered(x, y);
    }
    ...
    public static boolean isUnordered(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64QuietUnordered(x, y);
    }
    ...
    public static long roundIntegralExact(@Decimal final long x) {
        return NativeMathImpl.bid64RoundIntegralExact(x);
    }
    ...
    public static long roundIntegralNearestEven(@Decimal final long x) {
        return NativeMathImpl.bid64RoundIntegralNearestEven(x);
    }
    ...
    public static long roundIntegralNegative(@Decimal final long x) {
        return NativeMathImpl.bid64RoundIntegralNegative(x);
    }
    ...
    public static long roundIntegralPositive(@Decimal final long x) {
        return NativeMathImpl.bid64RoundIntegralPositive(x);
    }
    ...
    public static long roundIntegralZero(@Decimal final long x) {
        return NativeMathImpl.bid64RoundIntegralZero(x);
    }
    ...
    public static long roundIntegralNearestAway(@Decimal final long x) {
        return NativeMathImpl.bid64RoundIntegralNearestAway(x);
    }

    //@Decimal public static long nextUp(@Decimal final long x) { return NativeMathImpl.bid64Nextup(x); }

    //@Decimal public static long nextDown(@Decimal final long x) { return NativeMathImpl.bid64Nextdown(x); }
    ...
    public static long nextAfter(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64Nextafter(x, y);
    }
    ...
    public static long minNum(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64Minnum(x, y);
    }
    ...
    public static long minNumMag(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64MinnumMag(x, y);
    }
    ...
    public static long maxNum(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64Maxnum(x, y);
    }
    ...
    public static long maxNumMag(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64MaxnumMag(x, y);
    }
    ...
    public static long fromInt32(final int x) {
        return NativeMathImpl.bid64FromInt32(x);
    }
    ...
    public static long fromUInt32(final int x) {
        return NativeMathImpl.bid64FromUint32(x);
    }
    ...
    public static long fromInt64(final long x) {
        return NativeMathImpl.bid64FromInt64(x);
    }
    ...
    public static long fromUInt64(final long x) {
        return NativeMathImpl.bid64FromUint64(x);
    }
    ...
    public static boolean isSigned(@Decimal final long x) {
        return NativeMathImpl.bid64IsSigned(x);
    }
    ...
    public static boolean isSubnormal(@Decimal final long x) {
        return NativeMathImpl.bid64IsSubnormal(x);
    }
...
//     * @return The check flag.
//     */
//    public static boolean isFinite(@Decimal final long x) { return NativeMathImpl.bid64IsFinite(x) ; }
...
//     * @return The check flag.
//     */
//    public static boolean isZero(@Decimal final long x) { return NativeMathImpl.bid64IsZero(x) ; }
    ...
    public static boolean isInf(@Decimal final long x) {
        return NativeMathImpl.bid64IsInf(x);
    }
    ...
    public static boolean isSignaling(@Decimal final long x) {
        return NativeMathImpl.bid64IsSignaling(x);
    }
    ...
    public static boolean isCanonical(@Decimal final long x) {
        return NativeMathImpl.bid64IsCanonical(x);
    }
...
//     * @return The check flag.
//     */
//    public static boolean isNaN(@Decimal final long x) { return NativeMathImpl.bid64IsNaN(x) ; }

    //@Decimal public static long copy(@Decimal final long x) { return NativeMathImpl.bid64Copy(x); }
    //@Decimal public static long negate(@Decimal final long x) { return NativeMathImpl.bid64Negate(x); }
    //@Decimal public static long abs(@Decimal final long x) { return NativeMathImpl.bid64Abs(x); }
    ...
    public static long copySign(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64CopySign(x, y);
    }
    ...
    public static int classOfValue(@Decimal final long x) {
        return NativeMathImpl.bid64Class(x);
    }
    ...
    public static boolean isSameQuantum(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64SameQuantum(x, y);
    }
    ...
    public static boolean isTotalOrder(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64TotalOrder(x, y);
    }
    ...
    public static boolean isTotalOrderMag(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64TotalOrderMag(x, y);
    }
    ...
    public static int radix(@Decimal final long x) {
        return NativeMathImpl.bid64Radix(x);
    }
    ...
    public static long rem(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64Rem(x, y);
    }
    ...
    public static int ilogb(@Decimal final long x) {
        return NativeMathImpl.bid64Ilogb(x);
    }
    ...
    public static long scalbn(@Decimal final long x, final int n) {
        return NativeMathImpl.bid64Scalbn(x, n);
    }
    ...
    public static long ldexp(@Decimal final long x, final int n) {
        return NativeMathImpl.bid64Ldexp(x, n);
    }
    ...
    public static long quantize(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64Quantize(x, y);
    }
    ...
    public static float toBinary32(@Decimal final long x) {
        return NativeMathImpl.bid64ToBinary32(x);
    }
    ...
    public static double toBinary64(@Decimal final long x) {
        return NativeMathImpl.bid64ToBinary64(x);
    }
    ...
    public static long logb(@Decimal final long x) {
        return NativeMathImpl.bid64Logb(x);
    }
    ...
    public static long nearByInt(@Decimal final long x) {
        return NativeMathImpl.bid64Nearbyint(x);
    }
    ...
    public static long fdim(@Decimal final long x, @Decimal final long y) {
        return NativeMathImpl.bid64Fdim(x, y);
    }
    ...
    public static int quantExp(@Decimal final long x) {
        return NativeMathImpl.bid64Quantexp(x);
    }
    ...
    public static long quantum(@Decimal final long x) {
        return NativeMathImpl.bid64Quantum(x);
    }
