...
OSXCROSS_HOST=$CROSS_HOST-$OSXCROSS_HOST_SUFFIX \
	...
	cmake -G "Unix Makefiles" -DVERSION_SUFFIX=$1 -DCMAKE_VERBOSE_MAKEFILE=$VERBOSE -DCMAKE_TOOLCHAIN_FILE=$OSXCROSS_TARGET_DIR/toolchain.cmake -DCMAKE_INSTALL_PREFIX=../ -DINSTALL_SUFFIX=Darwin/$CROSS_HOST -DAPPLE=TRUE ../
make install
